...
class Unit:
    ...
    def __init__(self, x, y, image, team, power=1, points=5, diagonal=False, tile_size=50):
        ...
        self.speed = 0.1
        self.target_screen_x, self.target_screen_y = self.screen_x, self.screen_y
    ...
    def is_static(self):
        if self.destination is None:
            ...
            return
        if (
            abs(self.screen_x - self.target_screen_x) < 0.1
            and abs(self.screen_y - self.target_screen_y) < 0.1
        ):
