...
# TODO: A SUPPRIMER SI NON UTILISE
...
class ExplorerGroup(Ant):
    ...
    def add_explorer(self, explorer):
        ...
        self.exploration_radius = len(
            self.explorers
        )  # Suffit pas d'avoir débloqué le précédent, pour explorer faut avoir autant d'explorateurs que la hauteur du graphe
